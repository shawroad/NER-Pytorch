...
def set_args():
    ...
    parser.add_argument('--ent2id_path', default='../data/ent2id.json', type=str, help='验证数据')
    parser.add_argument('--pretrain_model_path', default='./mengzi_pretrain', type=str, help='验证数据')
