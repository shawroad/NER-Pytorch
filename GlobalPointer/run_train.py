...
if __name__ == '__main__':
    ...
    tokenizer = BertTokenizerFast.from_pretrained(args.pretrain_model_path, add_special_tokens=True, do_lower_case=False)
    ent2id = load_data(args.ent2id_path, "ent2id")  # 实体类别个数

    ent_type_size = len(ent2id)

    data_maker = DataMaker(tokenizer)   # 对数据的处理
    ...
    for epoch in range(args.num_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            print('epoch:{}, step:{}, loss:{:10f}, precision:{:10f}, f1:{:10f}'.format(
