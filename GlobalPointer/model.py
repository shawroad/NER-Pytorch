...
class GlobalPointer(nn.Module):
    def __init__(self, ent_type_size=10, RoPE=True):
        ...
        self.encoder = BertModel.from_pretrained(args.pretrain_model_path)
    ...
    def forward(self, input_ids, attention_mask, token_type_ids):
        ...
        mask = torch.tril(torch.ones_like(logits), -1)   # 因为下三家和上三角对称
        # mask: 左下三角为1  右上三角为0

        logits = logits - mask * 1e12   # 相当于将左下三角弄成很大的复制
        # print(logits.size())   # torch.Size([2, 10, 512, 512])
